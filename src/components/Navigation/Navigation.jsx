const Navigation = () => {
  ...
  return (
    <nav className="fixed left-1/2 -translate-x-1/2 bottom-0 lg:bottom-auto lg:top-0 lg:left-auto lg:right-10 lg:translate-x-0 flex justify-center items-center border mx-auto py-1 px-1 bg-white lg:m-5 lg:w-fit w-full lg:rounded-full bg-opacity-90 backdrop-blur-3xl z-30">
